# 
# Project automation script for mode2 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source mode2.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../srcs/partial_led_test_m2.v"

   # Set the Top Module as well...
   project set top "partial_led_test_0"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "D:/SHS/Research/zycap_master_repo/zycap/exdesign/ise/hw/modes/mode2/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "partial_led_test_0" -process "Generate IBIS Model"
