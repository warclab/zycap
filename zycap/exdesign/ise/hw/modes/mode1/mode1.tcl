# 
# Project automation script for mode1 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source mode1.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "../srcs/partial_led_test_m1.v"
...
proc set_process_props {} {
   ...
   project set "Work Directory" "D:/SHS/Research/zycap_master_repo/zycap/exdesign/ise/hw/modes/mode1/xst" -process "Synthesize - XST"
